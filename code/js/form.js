...
function form_confirm(obj) {
    ...
    flag = true;
    document.forms.adviserForm.submit;
}
...
function form_regist() {
    ...
    flag = true;
    document.forms.adviserForm.operation.value = "regist";
    document.forms.adviserForm.submit;
}
function form_back() {
    if (flag) {
    ...
    flag = true;
    document.forms.adviserForm.operation.value = "back";
    document.forms.adviserForm.submit;
}
...
function checkValidateMust(form_name,message){
    ...
    if(document.forms.adviserForm[form_name].value == ""){ // 「お名前」の入力をチェック
