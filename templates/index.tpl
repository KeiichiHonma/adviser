...
<div id="header" class="clearfix">
    ...
    <div id="c-navi">
        ...
        <div id="c-bt">
        <img src="/img/common/contact_img02.gif" alt="お問い合わせ先電話番号" />
        <a href="/inquiry/input"><img src="/img/common/bt_contact01_off.jpg" alt="お問い合わせはこちら" /></a>
        </div>
    </div>
</div><!--#header-->
...
<a href="/inquiry/input"><img src="/img/index/top_contact.jpg" alt="お問い合わせ" /></a>
