...
<div id="roof_l_white">
    <div class="inside_l">
        ...
        <h2 class="h_title">SEO変更</h2>
        <p class="m_b10">以下の項目を入力して[変更]ボタンをクリックしてください。<span class="attention">＊</span>の項目は必須となります。</p>
        <form id="adviserForm" name="adviserForm" action= "{$smarty.const.ADVISERURL}/system/seo/edit/input/uid/{$user.0._id}/sid/{$seo.0._id}" method="post">
        ...
        <tr>
        <td colspan="2">{$seo.0.col_absolute_html_file}<input type="hidden" name="absolute_html_file" value="{$seo.0.col_absolute_html_file}" /></td>
        </tr>
        </table>
