...
<div id="roof_l_white">
    ...
    <h2 class="h_title">{$manager.0.col_given_name} - パスワード変更</h2>
    <p class="m_b10">以下の項目を入力して[確認画面へ]ボタンをクリックしてください。<span class="attention">＊</span>の項目は必須となります。</p>
    <form id="adviserForm" name="adviserForm" action= "{$smarty.const.ADVISERURL}/system/manager/edit/password/input/mid/{$manager.0._id}" method="post">
